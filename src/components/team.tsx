...
const Team: React.FC = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      name: "Kenjie Balona",
      role: "Developer",
      profileImg: getImage(team.Kenjie),
      linkedIn: "https://www.linkedin.com/in/chipzroar/",
    },
    {
      name: "Ivanne Bayer",
    ...
    {
      name: "Matthew Desabelle",
      role: "Junior Developer",
      profileImg: getImage(team.Matt),
      linkedIn: "https://www.linkedin.com/in/matthew-dave-desabelle-2bb917324/",
    },
    {
