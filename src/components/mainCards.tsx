        ...
        <div className="grid grid-cols-6 gap-4">
            {data.map((card, index) => {
                ...
                return (
                    <div
                        key={index}
                        className={`col-span-6 ${colSpan} rounded-[24px] p-[32px] xl:p-[48px] border-[1px] border-gray-tint flex flex-col gap-y-[10px] transition-all duration-500 ${
                            activeCard === cardOrder.indexOf(index)
