      ...
      <div className="px-6">
        <div className="max-w-[1200px] m-auto mt-[24px]">
          <header className="flex justify-between text-white p-[24px] bg-[#1010108F] border-[1px] border-solid border-transparent rounded-[24px] backdrop-blur-md shadow-[0_4px_21px_0_#00000040]">
            ...
            <Button href="https://saib.dev/" target="_blank" variant="contained" className="!rounded-[50px] !hidden xl:!block !py-[12px] !px-[24px] h-fit !text-[18px] !normal-case !font-poppins !font-normal">Let's Talk!</Button>
          </header>
          ...
          <main className="mt-16 md:mt-[180px] xl:mt-[169px]">
            <div className="max-w-[630px] m-auto text-center text-white">
              ...
              <Button href="https://saib.dev/" target="_blank" variant="contained" className="!rounded-[50px] !hidden xl:!block !py-[12px] !px-[24px] !text-[18px] !normal-case !font-poppins !font-normal !m-auto !mt-6">Let's Talk!</Button>
            </div>
