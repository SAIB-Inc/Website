      ...
      <section className="backgroundImage pt-6">
        ...
        <div className="bg-white w-full">
          <div className="max-w-[1200px] m-auto relative p-6 bg-white pb-[120px]">
            <div className="absolute top-[-100px] p-[48px]  w-full left-1/2 transform -translate-x-1/2 bg-white/70 backdrop-blur-md transparent rounded-3xl shadow-lg backgroundImage2">
            ...
            <div className="max-[390px]:mt-[32rem] max-lg:mt-[22rem] mt-[20rem] m-auto max-w-[500px] text-[34px] sm:text-[52px] text-center !p-0 mb-[50px]">
            ...
            <div className="grid grid-cols-6 gap-4">
              <div className="col-span-6 md:col-span-3 rounded-[24px] p-[48px] border-[1px] border-gray-tint flex flex-col gap-y-[10px]">
                ...
                <p className="text-[30px] xl:text-[45px] tracking-tighter font-bold">Frontened Excellence</p>
        ...
        <div className="max-w-[1200px] m-auto pb-[50px] mt-[130px] xl:mt-[226px] text-white pb-16 px-[20px]">
              <h2 className="text-[36px] md:text-[52px] font-bold leading-[62px] text-center">Our Team</h2>
              <Team/>
        </div>
        <div className="max-w-[1200px] m-auto mt-[130px] xl:mt-[100px] text-white max-sm:py-[80px] py-16 px-2 xl:p-[80px] rounded-[24px] bg-[#1010108F] border-[1px] border-solid border-transparent backdrop-blur-md shadow-[0_4px_21px_0_#00000040] max-lg:mx-[20px]">
        ...
        <div className="max-w-[1200px] m-auto mt-[130px] xl:mt-[100px] text-white max-sm:py-[80px] py-16 px-2 xl:p-[80px] rounded-[24px] bg-[#1010108F] border-[1px] border-solid border-transparent backdrop-blur-md shadow-[0_4px_21px_0_#00000040] max-lg:mx-[20px]">
              ...
              <div className="max-lg:flex-col max-lg:items-center max-lg:justify-center max-lg:gap-[40px] flex gap-[20px] justify-evenly mt-[55px] sm:mt-[45px]">
                ...
                <StaticImage alt="" src="../images/partners/dc-spark.svg" className="w-[290px] h-[50px] sm:w-[350px] sm:h-[70px]"/>
              </div>
        </div>
        <div className="bg-white h-[237px] relative backgroundImage3 mt-[130px]">
          <div className="max-w-[1200px] h-full flex justify-between items-center m-auto max-md:flex-col max-md:items-center max-md:justify-center max-md:text-center max-md:gap-[20px] max-md:text-white max-xl:px-6">
            <p className="text-[34px] xs:text-[40px] md:text-[46px] lg:text-[64px] font-bold tracking-tight">Start Working with us!</p>
